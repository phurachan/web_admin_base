...
export const MODEL_VALIDATION_MESSAGES = {
  ...
  PERMISSION_MODULE_NAME_REQUIRED: 'PERMISSION_MODULE_NAME_REQUIRED',
  ...
  PERMISSION_CODE_MAX_LENGTH: 'PERMISSION_CODE_MAX_LENGTH',
  ...
  PERMISSION_MODULE_NAME_MAX_LENGTH: 'PERMISSION_MODULE_NAME_MAX_LENGTH',
  PERMISSION_RESOURCE_MAX_LENGTH: 'PERMISSION_RESOURCE_MAX_LENGTH',
  PERMISSION_ICON_MAX_LENGTH: 'PERMISSION_ICON_MAX_LENGTH',
  PERMISSION_PATH_MAX_LENGTH: 'PERMISSION_PATH_MAX_LENGTH',
